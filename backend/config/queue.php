    ...
    */
    ...
    'connections' => [
        ...
        'database' => [
            ...
            // Media batches may legitimately run for up to five minutes.
            // Keep retry_after above the longest worker/job timeout so the
            // same media object is never processed concurrently.
