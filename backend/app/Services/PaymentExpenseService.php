...
class PaymentExpenseService
{
     ...
     *     summary: array{total_count: int, total_amount: float, current_month_amount: float, latest_expense_date: string|null}
     * }
     */
    ...
    /**
     * @return array{total_count: int, total_amount: float, current_month_amount: float, latest_expense_date: string|null}
     */
