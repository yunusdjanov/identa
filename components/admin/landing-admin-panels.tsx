...
function getAdminLandingCopy(locale: string): AdminLandingCopy {
    return ADMIN_LANDING_COPY[locale as AdminLocale] ?? ADMIN_LANDING_COPY.en;
}

function getAdminLocale(locale: string): AdminLocale {
...
export function AdminLandingSettingsPanel() {
    const { locale } = useI18n();
    const copy = getAdminLandingCopy(locale);
    ...
    return (
        <Card className="interactive-card rounded-[1.5rem] bg-white/95">
            <CardHeader>
                ...
                <p className="text-sm text-slate-500">{copy.landing.description}</p>
            </CardHeader>
                ...
                {settingsQuery.isLoading ? (
                    ...
                    <>
                        ...
                        <div className="flex justify-end">
                            ...
                            >
                                {landingSettingsMutation.isPending ? copy.landing.saving : copy.landing.save}
                            </Button>
                        </div>
                    </>
                )}
...
export function AdminLeadRequestsPanel() {
    const { locale } = useI18n();
    ...
    return (
        <Card className="interactive-card rounded-[1.5rem] bg-white/95">
            <CardHeader>
                ...
                <p className="text-sm text-slate-500">{copy.leads.description}</p>
            </CardHeader>
