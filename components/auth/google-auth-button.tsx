    ...
    if (!isConfigured) {
        return (
            <Button
                type="button"
                variant="outline"
                className="h-10 w-full justify-between gap-3 rounded-full border-slate-300/80 bg-white/95 px-4 text-sm font-semibold text-slate-800 shadow-sm shadow-cyan-950/5 backdrop-blur transition hover:bg-white/95 disabled:cursor-not-allowed disabled:opacity-100"
                disabled
        ...
        <div className="relative min-h-10 w-full overflow-hidden rounded-full">
            ...
            {!isReady || isPending ? (
                <Button
                    type="button"
                    variant="outline"
                    className="absolute inset-0 h-10 w-full justify-center gap-3 rounded-full border-slate-300/80 bg-white/95 px-4 text-sm font-semibold text-slate-800 shadow-sm shadow-cyan-950/5 backdrop-blur disabled:opacity-100"
                    disabled
                >
                    <GoogleMark />
                    <span>{label}</span>
