            ...
            <div className="relative mx-auto flex min-h-screen w-full max-w-5xl flex-col px-4 py-4 sm:px-6 lg:px-8">
                <header className="flex min-h-12 items-center justify-between gap-3">
                    ...
                    <div className="flex min-w-0 items-center gap-2">
                        <Link
                            href="/"
                            className="hidden min-h-9 items-center rounded-full border border-slate-200/80 bg-white/60 px-4 text-sm font-semibold text-slate-700 shadow-sm shadow-teal-950/5 backdrop-blur transition hover:bg-white hover:text-slate-950 sm:inline-flex"
                        >
                            {t('auth.backToHome')}
                        </Link>
                        <LanguageSwitcher
                            variant="compact"
                            className="bg-white/70 text-slate-800 shadow-sm shadow-teal-950/5 ring-1 ring-slate-200/80 backdrop-blur hover:bg-white data-[state=open]:bg-white"
                        />
                    </div>
                </header>
