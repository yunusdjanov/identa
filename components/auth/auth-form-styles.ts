export const authCardClassName =
    'gap-0 overflow-hidden rounded-[1.75rem] border border-slate-200/95 bg-white/96 p-0 shadow-2xl shadow-cyan-950/12 ring-1 ring-teal-700/10 backdrop-blur-xl';
