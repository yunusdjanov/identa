  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-[state=active]:bg-teal-50 data-[state=active]:text-teal-700 data-[state=active]:font-semibold data-[state=active]:!ring-1 data-[state=active]:!ring-teal-300 data-[state=active]:focus-visible:!border-transparent dark:data-[state=active]:text-foreground dark:data-[state=active]:border-input dark:data-[state=active]:bg-input/30",
