...
export const PATIENTS = [
    ...
    { id: 'pat-2', patient_id: 'P-002', full_name: 'Malika Yusupova', phone: '+998901002002', secondary_phone: '+998909002002', gender: 'female', date_of_birth: '1992-07-22', address: "Toshkent sh., Yunusobod tumani, 12-mavze, 5-uy", allergies: "Penitsillinga allergiya (og'ir shakl)", current_medications: "Vitamin D3 1000 IU, Omega-3 kapsulalar", medical_history: "2019 — gipotireoz (qalqonsimon bez), Levotiroxin qabul qiladi", created_at: '2025-02-15T09:00:00Z', last_visit_at: '2026-05-23T11:30:00Z', is_archived: false, categories: [CATEGORIES[0]] },
