        ...
        <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
            {cards.map((card) => {
                ...
                return (
                    <section
                        key={card.title}
                        className={`rounded-2xl border p-3 shadow-sm shadow-slate-200/50 ${card.className}`}
                    >
                        <div className="flex items-start justify-between gap-3">
                            ...
                            <span className="inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-white/85 shadow-sm ring-1 ring-white/80">
